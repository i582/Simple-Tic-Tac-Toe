...
final class BattleField implements Cloneable {
    ...
    protected BattleField clone() {
        try {
            return (BattleField) super.clone();
    ...
    public String gameStatus() {
        final boolean XWins = isWin(fieldsOfX);
        final boolean OWins = isWin(fieldsOfO);
    ...
    public ArrayList<Move> emptyFields() {
        ArrayList<Move> fields = new ArrayList<>();
    ...
    public boolean isPossibleMove(Move move) {
        return fieldsOfX != setField(move.X, move.Y, fieldsOfX) &&
                fieldsOfO != setField(move.X, move.Y, fieldsOfO);
    }
